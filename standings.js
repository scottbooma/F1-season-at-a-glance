...
const driverStatsBaseURL = "https://ergast.com/api/f1/current/drivers/"
...
form.addEventListener("change", event => {
  ...
  })).then(driverStatsArray => {
    const driverInfo = driverStatsArray[0].MRData.RaceTable.Races[0].Results[0]
    const raceResults = driverStatsArray[0].MRData.RaceTable.Races
    const sprintResults = driverStatsArray[1].MRData.RaceTable.Races
...
fetch(constructorStandingsURL)
  ...
  .then(constructorStandingsObject => {
    ...
    constructorStandingsList.forEach(constructorStanding => {
      addConstructorStandingListing(
        createConstructorStandingListing(constructorStanding),
      )
    },
    )
  })
...
function createDriverStandingListing (driverStanding) {
  ...
  driver.innerHTML = `
        ...
        <td><img src="images/constructors/${driverStanding.Constructors[0].constructorId}.png" 
          alt="${driverStanding.Constructors[0].constructorId}" 
          class="standings-logo"/></td>
...
function createConstructorStandingListing (constructorStanding) {
  ...
  constructor.innerHTML = `
        ...
        <td><img src="images/constructors/${constructorStanding.Constructor.constructorId}.png" 
          alt="${constructorStanding.Constructor.constructorId}" 
          class="standings-logo"/></td>
